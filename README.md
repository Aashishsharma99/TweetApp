...
class MdnMapperTest {
    /**
     * Method under test: {@link MdnMapper#mapFromContext(Object)}
     */
    @Test
    void testMapFromContext() throws NamingException {
        MdnMapper mdnMapper = new MdnMapper();
        assertEquals(2, mdnMapper.mapFromContext(new DirContextAdapter()).getObjectclass().length);
    }
  ...
  //  @Disabled("TODO: Complete this test")
    void testMapFromContext2() throws NamingException {
        // TODO: Complete this test.
        //   Reason: R013 No inputs found that don't throw a trivial exception.
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        //   java.lang.NullPointerException
        //       at com.verizon.onemsg.omppservice.mapper.MdnMapper.mapFromContext(MdnMapper.java:21)
        //   In order to prevent mapFromContext(Object)
        //   from throwing NullPointerException, add constructors or factory
        //   methods that make it easier to construct fully initialized objects used in
        //   mapFromContext(Object).
        //   See https://diff.blue/R013 to resolve this issue.

        (new MdnMapper()).mapFromContext(null);
    }
}
